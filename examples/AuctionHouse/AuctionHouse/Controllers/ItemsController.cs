...
namespace AuctionHouse.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(ILogger<HomeController> logger, IItemRepository itemRepo, ISellerRepository sellerRepo)
        {
            _logger = logger;
        ...
        public IActionResult Create()
        {
            ...
            var selectList = new SelectList(
                _sellerRepository.Sellers().Select(s => new {Text = $"{s.FirstName} {s.LastName}",Value = s.Id}),
                "Value","Text");
